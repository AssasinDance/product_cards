...
function ListOfCards({products, setSelectedProduct}) {

    if (products && products.length !== 0) {
        return (
            <ul className='product-cards'>
                {products.map((product) => (<li key={product.id} onClick={() => setSelectedProduct(product)} className='product-cards__card'>
